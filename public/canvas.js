...
function createWorld() {
    ...
    var v = document.getElementById("canvasSelection").value;
...
function updateStats() {
    ...
    fbSpan.innerHTML =
        ...
        "<br>View center: "+myRound(currentViewCenterWorld.x,3)+", "
            + myRound(currentViewCenterWorld.y,3) +
...
function getNextCanvas() {
    window.location = '/box2d/' + document.getElementById("canvasSelection").value + '/next';
}

function getPrevCanvas() {
    window.location = '/box2d/' + document.getElementById("canvasSelection").value + '/prev';
}